...
/**
  ...
  * @array: Pointer to the first element of the [sub]array to be searched.
  * @left: The starting index of the [sub]array to search.
  * @right: The ending index of the [sub]array to search.
  * @value: The value to be searched for.
  *
  * Return: If the value is not found, returns -1.
  *         Otherwise, returns the index where the value is located.
  *
  * Description: Prints the [sub]array being searched after each step.
  */
...
/**
  ...
  *         Otherwise, returns the first index where the value is found.
  *
  * Description: Prints the [sub]array being searched after each iteration.
  */
